...
const Menu = ({ history }) => (
  ...
  <nav className="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav" data-test="nav-element">
      ...
      <div className="collapse navbar-collapse" id="navbarResponsive">
          ...
          {!isAuthenticated() && (
            <>
              {/* <li className="nav-item">
                <Link className="nav-link js-scroll-trigger" to="/posts">All Places</Link>
              </li> */}
        ...
        {isAuthenticated() && (
          <>
            <ul className="navbar-nav text-uppercase ml-auto">
              <li className="nav-item">
                <Link className="nav-link js-scroll-trigger" to={`/category/create`}>
                  Create Category
                      </Link>
              </li>
              <li className="nav-item">
