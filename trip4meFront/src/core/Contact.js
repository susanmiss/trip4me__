    ...
    <form method="POST" action="sendemail">
      <div className="row">
        ...
        <div className="col-lg-12 text-center">
          ...
          <button id="sendMessageButton" className="btn btn-primary btn-xl text-uppercase" onClick={this.sendEmail}>Send Message</button>
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="alert alert-info" style={{ display: open ? "" : "none" }}>
                  Yor message has been sent. Thank you :)
